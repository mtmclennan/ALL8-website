    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 mt-10 sm:px-6 sm:mt-0 py-20 md:py-28">
        <div className="grid grid-cols-1 items-center gap-8 lg:grid-cols-12">
          <div className="md:col-span-7">
            <h1 className="text-5xl text-center md:text-left font-bold tracking-tight md:text-7xl/20 2xl:text-8xl/25">
              Contractor Websites That Get More Calls
            </h1>

            <p className="mt-4 text-base text-white/80 md:text-lg">
              Fast, conversion-focused sites that turn local traffic into{' '}
              <span className="font-semibold text-white">
                calls, quotes, and booked jobs
              </span>{' '}
              across Canada.
            ...
            {/* Proof block (demo-based for now)
            <div className="mt-8 inline-flex flex-wrap items-center gap-3 rounded-2xl border border-white/15 bg-black/20 px-4 py-3">
              <div className="flex items-center gap-2 text-sm text-white/90">
                <ShieldCheck className="h-4 w-4 text-white/80" />
                <span className="font-semibold text-white">Proof:</span>
                <span className="text-white/80">
                  Demo tune-ups improving Lighthouse from{' '}
                  <span className="font-semibold text-white">45 → 95+</span> and
                  cutting load time{' '}
                  <span className="font-semibold text-white">
                    ~4.5s → ~1.2s
                  </span>
            ...
            <p className="mt-4 text-sm text-white/60">
              Serving contractors, trades, and service businesses across Canada.
            </p>
          </div>
